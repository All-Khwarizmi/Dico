  ...
  return (
    <main className='h-screen w-screen'>
      ...
      <div className='flex h-[80%] flex-col  items-center gap-5'>
        <div className=' h-[60%] max-h-[80%] w-[60%] rounded-lg overflow-scroll rounded border-2 border-solid dark:border-gray-600 dark:bg-gray-700 shadow-md shadow-gray-500 '>
