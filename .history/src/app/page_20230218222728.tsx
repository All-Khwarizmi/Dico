  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col h-[80%] items-center gap-5'>
        ...
        {isTranslations && (
          <div className=' min-h-min max-h-60 md:max-h-96 lg:w-[40%] md:w-[50%] w-[90%] rounded-lg  overflow-scroll rounded border-2 border-solid dark:border-gray-600 dark:bg-gray-700 shadow-md shadow-gray-500 '>
