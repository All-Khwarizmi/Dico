  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col h-[80%] items-center gap-5'>
        ...
        {isTranslations && (
          <div className=' h-72  md:max-h-96 lg:w-[40%] md:w-[50%] w-[90%] rounded-lg  overflow-scroll rounded border-2 border-solid dark:border-gray-600 dark:bg-gray-700 shadow-md shadow-gray-500 '>
        ...
        <form className='text-black  ' onSubmit={(e) => submitWord(e)}>
          ...
          />
          <button
            className='rounded-lg border border-gray-400 border-1 rounded-l-none  dark:text-white  text-md font-bold 
            bg-purple-900 px-3 py-1 dark:py-1'
            type='submit'
          >
            Chercher
          </button>
