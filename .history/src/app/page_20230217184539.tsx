  ...
  return (
    <main className='h-screen w-screen'>
      ...
      <div className='flex h-[80%] flex-col  items-center gap-5'>
        ...
        <form className='text-black shadow-md sh' onSubmit={(e) => submitWord(e)}>
          <input
          ...
          />
          <button
            className='rounded-lg rounded-l-none bg-gray-400 dark:bg-gray-400 dark:text-white text-md font-bold dark:bg-purple-900 px-3 py-1 dark:py-1.5'
            type='submit'
          >
            Chercher
          </button>
