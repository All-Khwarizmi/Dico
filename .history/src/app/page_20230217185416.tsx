    ...
    <main className='h-screen w-screen'>
      ...
      <div className='flex h-[80%] flex-col  items-center gap-5'>
        ...
        <form className='text-black ' onSubmit={(e) => submitWord(e)}>
          ...
          />
          <button
            className='rounded-lg border border-gray-400 border-1 rounded-l-none bg-gray-400 dark:text-white border-l-none text-md font-bold dark:bg-purple-900 px-3 py-1 dark:py-1'
            type='submit'
          >
            Chercher
          </button>
