  ...
  return (
    ...
    >
        ...
        <div className='flex relative flex-col  items-center gap-5'>
          ...
          {isTranslations && (
            <div className='  lg:w-[40%] md:w-[50%] w-[90%] rounded-lg  overflow-scroll rounded border-2 border-solid dark:border-gray-600 dark:bg-gray-700 shadow-md shadow-gray-500 '>
