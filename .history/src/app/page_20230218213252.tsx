  ...
  return (
    ...
    >
      <div className='h-full'>
        <div className='grid place-items-center content-center  w-full  '>
          {isFr ? (
            <div
        ...
        <div className='flex relative flex-col  items-center gap-5'>
          ...
          {isTranslations && (
            <div className=' min-h-[60%] max-h-[80%] lg:w-[40%] md:w-[50%] w-[90%] rounded-lg  overflow-scroll rounded border-2 border-solid dark:border-gray-600 dark:bg-gray-700 shadow-md shadow-gray-500 '>
