...
export default function Home() {
  ...
  return (
    <main className='h-screen w-screen'>
      ...
      <div className='flex h-[80%] flex-col border border-red-400 border-2 items-center gap-5'>
        <div className=' h-[60%] max-h-[80%] w-[60%] overflow-scroll rounded border-2 border-solid border-red-200 bg-red-200'>
