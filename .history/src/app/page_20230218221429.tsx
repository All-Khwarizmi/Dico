...
export default function Home() {
  ...
  return (
    ...
    >
        ...
        <div className='flex flex-col h- items-center gap-5'>
          {isLoading ? (
            !isTranslations ? (
          ...
          {isTranslations && (
            <div className=' min-h-[30%] max-h-[60%] lg:w-[40%] md:w-[50%] w-[90%] rounded-lg  overflow-scroll rounded border-2 border-solid dark:border-gray-600 dark:bg-gray-700 shadow-md shadow-gray-500 '>
