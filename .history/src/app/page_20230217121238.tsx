    ...
    <main className='h-screen w-screen'>
      ...
      <div className='flex h-full w-full flex-col items-center gap-5'>
          ...
          <div className='text-black'>
            <div>
              <table className=' relative w-full text-left text-sm text-gray-500 dark:text-gray-400'>
                <thead className=' bg-gray-400 sticky top-0 bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400'>
                  <tr>
        ...
        <form className='text-black' onSubmit={(e) => submitWord(e)}>
          ...
          />
          <button
            className='rounded-lg rounded-l-none bg-gray-400 dark:bg-purple-500 px-3 py-1'
            type='submit'
          >
            Chercher
          </button>
