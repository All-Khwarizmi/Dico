  ...
  return (
    <main className='h-screen w-screen'>
      ...
      <div className='flex h-[80%] flex-col  items-center gap-5'>
        <div className=' h-[60%] max-h-[80%] w-[60%] overflow-scroll rounded border-2 border-solid dark:border-gray-600 shadow-md shadow-gray-500 '>
        ...
        <form className='text-black' onSubmit={(e) => submitWord(e)}>
          <input
            ...
            className='rounded-lg border dark:text-white border-1 bg-gray-400 text-black dark:bg-gray-700 rounded-r-none px-3 py-1'
            type='text'
            name='word'
            id='word'
          />
          <button
            className='rounded-lg rounded-l-none dark:bg-gray-400 dark:text-white font-bold dark:bg-purple-900 px-3 py-1 dark:py-1.5'
            type='submit'
          >
            Chercher
          </button>
