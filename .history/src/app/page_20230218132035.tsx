    ...
    >
      <div>
        ...
        <div className='flex relative h-[80%] flex-col  items-center gap-5'>
          ...
          {isTranslations && (
            <div className=' h-[60%] max-h-[80%] lg:w-[30%] md:w-[50%] w-[90%] rounded-lg  overflow-scroll rounded border-2 border-solid dark:border-gray-600 dark:bg-gray-700 shadow-md shadow-gray-500 '>
