    ...
    <main className='h-screen w-screen'>
      ...
      <div className='flex h-[80%] flex-col  items-center gap-5'>
          ...
          <div className='text-black '>
            <div className=''>
              <table className='  relative w-full text-left text-sm text-gray-500 dark:text-gray-400'>
                <thead className='  sticky top-0 bg-gray-400 text-white dark:bg-gray-900 text-xs uppercase text-gray-700 '>
                  <tr>
        ...
        <form className='text-black' onSubmit={(e) => submitWord(e)}>
          ...
          />
          <button
            className='rounded-lg rounded-l-none bg-gray-400 dark:bg-gray-400 dark:text-white font-bold dark:bg-purple-900 px-3 py-1 dark:py-1.5'
            type='submit'
          >
            Chercher
          </button>
